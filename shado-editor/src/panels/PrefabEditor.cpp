...
namespace Shado {
    ...
    PrefabEditor::PrefabEditor() {
        m_PrefabEditorHierarchyPanel = snew(SceneHierarchyPanel) SceneHierarchyPanel("Prefab Hierarchy", "Prefab Properties");
    }
    ...
    void PrefabEditor::onImGuiRender() {
        ...
        if (m_PrefabEditorPrefab) {
            ...
            if (ImGui::Button("Save and propagate")) {
                ...
                serializer.serializePrefab(newModifiedPrefab->root, newModifiedPrefab->GetId());
            }
            ImGui::SameLine();
